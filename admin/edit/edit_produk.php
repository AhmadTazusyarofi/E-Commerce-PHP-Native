...
$ambil = $koneksi->query("SELECT * FROM produk_foto JOIN produk
    ON produk_foto.id_produk=produk.id_produk WHERE id_produk_foto='$id_produk'");
    ...
    <div class="card shadow bg-white">
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-sm-3 col-form-label">Nama Kategori :</div>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <img src="../assets/foto_produk/<?php echo $edit['foto_produk']; ?>" width="200">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <textarea type="text" name="deskripsi" class="form-control"><?php echo $edit['deskripsi_produk']; ?>
                    </textarea>
                </div>
            </div>
